...
from stock.cron_worker import TaskTriggerView
...
urlpatterns = [
    ...
    # ── Pseudo-Worker Celery — déclenché par cron-job.org ──
    path('tasks/trigger-celery/', TaskTriggerView.as_view(), name='task_trigger'),
